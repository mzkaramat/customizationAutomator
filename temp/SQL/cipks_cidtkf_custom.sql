CREATE OR REPLACE PACKAGE BODY cipks_cidtkf_custom AS
     /*-----------------------------------------------------------------------------------------------------
     **
     ** File Name  : cipks_cidtkf_custom.sql
     **
   ...
   BEGIN
      l_Msg := 'cipks_cidtkf_Custom ==>'||p_Msg;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others Of cipks_cidtkf_Custom.Fn_Post_Build_type_structure ..');
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of cipks_cidtkf_Custom.Fn_Pre_Check_Mandatory ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of cipks_cidtkf_Custom.Fn_Post_Check_Mandatory ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of cipks_cidtkf_Custom.Fn_Pre_Default_And_Validate ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of cipks_cidtkf_Custom.Fn_Post_Default_And_Validate ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of cipks_cidtkf_Custom.Fn_Pre_Upload_Db ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of cipks_cidtkf_Custom.Fn_Post_Upload_Db ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of cipks_cidtkf_Custom.Fn_Pre_Query ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When others of cipks_cidtkf_Custom.Fn_Post_Query ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
